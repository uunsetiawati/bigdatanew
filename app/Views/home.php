...
<head>
  ...
  <link href="<?=base_url('assets/css/plugins/swiper-bundle.css')?>" rel="stylesheet" />
        ...
        <div class="static flex py-4 items-center justify-between sm:relative">
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
            <div class="flex flex-shrink-0 items-center justify-between">
              <a href="#">
                <img class="w-[130px]" src="<?=base_url('assets/images/logo-white.svg')?>" alt="Your Company" />
              </a>
            </div>
            <div class="grow">
              <div class="justify-end flex flex-row space-x-2 p-0 me-3">
                <a href="<?=base_url('login')?>" 
                  class="hidden sm:inline-block text-white/60 hover:text-white rounded-md px-3 py-2 text-base font-medium transition-all">Login</a>
