  ...
  <div class="navbar-wrapper">
    <div class="m-header flex items-center py-4 px-6 h-header-height">
      <a href="<?=base_url('/dashboard')?>" class="b-brand flex items-center gap-3">
        ...
        <img src="<?=base_url('assets/images/logoupt.png')?>" class="img-fluid" width="50%" alt="logo" />
        <img src="<?=base_url('assets/images/favicon.svg')?>" class="img-fluid logo logo-sm" alt="logo" />
      </a>
    </div>
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="" class="pc-link">
            ...
            <span class="pc-mtext">Pelatihan</span>
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="" class="pc-link">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-2 overflow-hidden">
        <div class="dropdown-header flex items-center justify-between py-4 px-5 bg-primary-500">
          <div class="flex mb-1 items-center">
            ...
            <div class="grow ms-3">
              <h6 class="mb-1 text-white"><?=$nama?> 🖖</h6>
        ...
        <div class="dropdown-body py-4 px-5">
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
            ...
            <div class="grid my-3">
              <a href="<?=base_url('/logout')?>" class="btn btn-primary flex items-center justify-center">
